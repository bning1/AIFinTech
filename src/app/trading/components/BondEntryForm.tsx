  ...
  return (
    <form className="glass" style={{ padding: "2rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
      ...
      <div style={{ gridColumn: "1 / -1" }}>
        <h3 style={{ borderBottom: "1px solid rgba(255,255,255,0.3)", paddingBottom: "0.5rem", color: "#1e293b" }}>Trade Details</h3>
      </div>
      <div>
      ...
      <div style={{ gridColumn: "1 / -1", marginTop: "1rem" }}>
        <h3 style={{ borderBottom: "1px solid rgba(255,255,255,0.3)", paddingBottom: "0.5rem", color: "#1e293b" }}>Instrument Parameters</h3>
      </div>
      <div>
      ...
      <div style={{ gridColumn: "1 / -1", textAlign: "right", marginTop: "1.5rem" }}>
        <a href="/" className="card-btn" style={{ marginRight: "1rem", padding: "0.8rem 2rem", fontSize: "1.1rem", textDecoration: "none", color: "#1e293b" }}>Cancel</a>
        <button type="button" className="card-btn" style={{ padding: "0.8rem 2rem", fontSize: "1.1rem", cursor: "pointer" }} onClick={() => alert("Trade Booked!")}>
          Book Trade
        </button>
      </div>
    </form>
